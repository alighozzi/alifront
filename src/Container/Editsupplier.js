...
class Editsupplier extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(
        "http://localhost:5000/api/show/fournisseur/" +
      ...
      .then((fournisseur) => {
        this.setState({
          ...
          url: fournisseur.data.url,
          categorie: fournisseur.data.categorie,
          sous_categorie: fournisseur.data.sous_categorie,
          taux_reponse: fournisseur.data.taux_reponse,
          taux_livraison: fournisseur.data.taux_livraison,
          note_moyenne: fournisseur.data.note_moyenne,
        });
      })
  ...
  handleSubmit(event) {
    ...
    axios
      .post(
        "http://localhost:5000/api/update/fournisseur/" +
          this.props.match.params.id,
        fournisseur,
        {
          headers: {
      ...
      .catch((error) => console.log("erreur :", error));
    swal({
      title: "Supplier updated successfuly",
      icon: "success",
      button: "Ok",
    });
        ...
        <form className="form1" onSubmit={this.handleSubmit}>
          ...
          <div className="showallBouton">
            <button type="submit" className="Boutonshowall">
              <span className="showallboutontext">Update supplier</span>
            </button>
          </div>
        </form>
      </div>
